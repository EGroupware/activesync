...
//                        0x05 => "Version='1.1'",
			...
			0x39 => "FirstDayOfWeek",		// >14.0
			0x3A => "OnlineMeetingInternalLink",	// 14.0
                    ), 5 => array (
                        0x05 => "Moves",
                        0x06 => "Move",
                        0x07 => "SrcMsgId",
			...
			0x1A => "Picture", 		// AS >14.0
			0x1B => "MaxSize", 		// AS >14.0
			0x1C => "Data", 		// AS >14.0
			0x1D => "MaxPictures", 		// AS >14.0
                    ), 0xb => array (
                        0x05 => "ValidateCert",
                        0x06 => "Certificates",
                        0x07 => "Certificate",
			...
			0x23 => "PrimarySmtpAddress",		// AS > 14.0
			0x24 => "Accounts",			// AS > 14.0
			0x25 => "Account",			// AS > 14.0
			0x26 => "AccountID",			// AS > 14.0
			0x27 => "AccountName",			// AS > 14.0
			0x28 => "UserDisplayName",		// AS > 14.0
			0x29 => "SendDisabled",			// AS > 14.0
			0x2B => "ihsManangementInformation",	// AS > 14.0
                    ), 0x13 => array( 				// 12.0
			0x05 => "LinkId",
			0x06 =>	"DisplayName",
			0x07 =>	"IsFolder",
			...
			0x0F => "CalendarType",
			0x10 => "IsLeapMonth",
			0x11 => "AccountId",			// AS > 14.0
			0x12 => "FirstDayOfWeek",		// AS > 14.0
			0x13 => "MeetingMessageType",		// AS > 14.0
		    ), 0x17 => array( 				// 14.0
			0x05 => "Subject",
			0x06 => "MessageClass",
